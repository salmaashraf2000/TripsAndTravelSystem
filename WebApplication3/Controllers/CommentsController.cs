...
namespace WebApplication3.Controllers
{
    ...
    public class CommentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,CommentDescription,ApplicationUserId,PostId")] Comment comment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CommentDescription,ApplicationUserId,PostId")] Comment comment)
        {
            if (ModelState.IsValid)
            {
